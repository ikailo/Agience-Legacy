...
namespace Agience.SDK.NetFramework.Reflection
{
    ...
    //        var sourceProvider = new NuGet.PackageSourceProvider(NuGet.NullSettings.Instance, new[]
    //        {
    //            new NuGet.PackageSource("https://api.nuget.org/v3/index.json"),
    //            new NuGet.PackageSource("https://f.feedz.io/autostep/ci/nuget/index.json")
    //        });
    ...
    //        var nugetSettings = NuGet.Settings.LoadDefaultSettings(packageDirectory);
    ...
    //                                       NuGet.ISettings nugetSettings, CancellationToken cancellationToken)
    //    {
    ...
    //                                                                          Microsoft.Extensions.Logging.ILogger logger, IEnumerable<ExtensionConfiguration> extensions,
    ...
    //               Enumerable.Empty<NuGet.PackageReference>(),
    ...
    //                                              Microsoft.Extensions.Logging.ILogger logger, IEnumerable<SourceRepository> repositories, DependencyContext hostDependencies,
    ...
    //    private bool DependencySuppliedByHost(DependencyContext hostDependencies, NuGet.PackageDependency dep)
    //    {
